...
char**** get_document(char* text) {
    ...
    // splitting text by '\n' and counting number of paragraphs
    ...
    // setting last position to NULL for the user
    ...
    while (paragraphs[i] != NULL) {
        ...
        // splitting sentences of paragraph by '.' and counting number of sentences
        ...
        while (sentences[j] != NULL) {
            ...
            // splitting string by ' ' and associate doc[i][j]
